...
//Class wheeled_d_baf : config.bin{
class CfgMovesBasic
{
	class DefaultDie;
	class ManActions
...
class CfgPatches
{
	...
	{
		units[] = {"BAF_ATV_D","BAF_Offroad_D, BAF_Jackal2_L2A1_D","BAF_Jackal2_GMG_D"};
		weapons[] = {};
		requiredVersion = 1.54;
		requiredAddons[] = {"CA_E","CAWeapons","CAWheeled_E","CACharacters_E","CAWheeled_E_ATV","CAWheeled_E_LandRover","CA_BAF","CACharacters_BAF","CAWeapons_BAF"};
	};
};
...
class CfgVehicles
{
	...
	class SUV_PMC_BAF: SUV_Base_EP1
	{
		...
		typicalCargo[] = {"CIV_Contractor1_BAF"};
	};
	class ATV_Base_EP1;
	...
	class BAF_Jackal2_BASE_D: Car
	{
		...
		soundGetIn[] = {"\Ca\sounds_baf\wheeled\jackal_door",1.0,1};
		soundGetOut[] = {"\Ca\sounds_baf\wheeled\jackal_door",1.0,1,30};
		soundEngineOnInt[] = {"\Ca\sounds_baf\wheeled\jackal_ext_on",1.0,1.0};
		soundEngineOnExt[] = {"\Ca\sounds_baf\wheeled\jackal_ext_on",1.0,1.0,100};
		soundEngineOffInt[] = {"\Ca\sounds_baf\wheeled\jackal_ext_off",1.0,1.0};
		soundEngineOffExt[] = {"\Ca\sounds_baf\wheeled\jackal_ext_off",1.0,1.0,100};
		...
		class SoundEvents
		{
			...
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_acceleration",0.56234133,1.0};
				limit = "0.15";
				expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[1.5, 5]) min (speed factor[5, 1.5]))";
			};
			class AccelerationOut
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_acceleration",0.56234133,1.0,300};
				limit = "0.15";
		...
		class Sounds
		{
			class Engine
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_low",1.4125376,0.6,200};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "camPos*engineOn*((rpm factor[0.3, 0.4]) min (rpm factor[0.7, 0.5]))";
			};
			class EngineHighOut
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_mid",1.4125376,0.6,300};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "camPos*engineOn*(rpm factor[0.5, 0.8])";
			};
			class IdleOut
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_idle",0.56234133,1.0,100};
				frequency = "1";
			...
			class EngineLowIn
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_low",1.4125376,0.6};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "(1-camPos)*engineOn*((rpm factor[0.3, 0.4]) min (rpm factor[0.7, 0.5]))";
			};
			class EngineHighIn
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_mid",1.4125376,0.6};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "(1-camPos)*engineOn*(rpm factor[0.5, 0.8])";
			};
			class IdleIn
			{
				sound[] = {"\Ca\sounds_baf\wheeled\jackal_ext_idle",0.7943282,1.0};
				frequency = "1";
				volume = "engineOn*(rpm factor[0.4, 0])*(1-camPos)";
			};
			class TiresRockIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-rock2",0.1,1.0};
				frequency = "1";
				volume = "(1-camPos)*rock*(speed factor[2, 20])";
			};
			class TiresSandIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-sand2",0.1,1.0};
				frequency = "1";
				volume = "(1-camPos)*sand*(speed factor[2, 20])";
			};
			class TiresGrassIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-grass3",0.1,1.0};
				frequency = "1";
				volume = "(1-camPos)*grass*(speed factor[2, 20])";
			};
			class TiresMudIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-mud2",0.1,1.0};
				frequency = "1";
				volume = "(1-camPos)*mud*(speed factor[2, 20])";
			};
			class TiresGravelIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-gravel2",0.1,1.0};
				frequency = "1";
				volume = "(1-camPos)*gravel*(speed factor[2, 20])";
			};
			class TiresAsphaltIn
			{
				sound[] = {"\ca\SOUNDS\Vehicles\Wheeled\Tires\ext\ext-tires-asphalt3",0.1,1.0};
				frequency = "1";
		...
		{
			tex[] = {};
			mat[] = {"ca\wheeled_d_baf\Data\Jackal_adds.rvmat","ca\wheeled_d_baf\Data\Jackal_adds_damage.rvmat","ca\wheeled_d_baf\Data\Jackal_adds_destruct.rvmat","ca\wheeled_d_baf\Data\Jackal_base.rvmat","ca\wheeled_d_baf\Data\Jackal_base_damage.rvmat","ca\wheeled_d_baf\Data\Jackal_base_destruct.rvmat","ca\wheeled_d_baf\Data\Jackal_mount.rvmat","ca\wheeled_d_baf\Data\Jackal_mount_damage.rvmat","ca\wheeled_d_baf\Data\Jackal_mount_destruct.rvmat"};
		};
		transportMaxMagazines = 90;
		class TransportMagazines
		{
	...
	class BAF_Jackal2_GMG_D: BAF_Jackal2_BASE_D
	{
		...
		class Turrets: Turrets
		{
			...
			class GMG_Turret: MainTurret
			{
				...
				soundServo[] = {"\ca\wheeled\Data\Sound\servo3",1e-006,1.0};
				weapons[] = {"BAF_GMG"};
				magazines[] = {"48Rnd_40mm_MK19","48Rnd_40mm_MK19","48Rnd_40mm_MK19","48Rnd_40mm_MK19","48Rnd_40mm_MK19","48Rnd_40mm_MK19"};
