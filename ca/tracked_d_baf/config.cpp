...
//Fri Oct 31 06:06:28 2014 : Source 'file' date Fri Oct 31 06:06:28 2014
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class tracked_d_baf : config.bin{
...
class CfgPatches
{
	class CATracked_BAF
	{
		...
		requiredAddons[] = {"CATracked_E","CACharacters_BAF","CA_BAF","CAWeapons_BAF"};
	};
};
class WeaponFireGun;
...
class CfgVehicles
{
	...
	class BAF_FV510_D: Tank
	{
		...
		typicalCargo[] = {"BAF_crewman_MTP","BAF_crewman_MTP"};
		commanderCanSee = 31;
		viewCargoShadow = 1;
		...
		cargoAction[] = {"M113_Cargo03_EP1","M113_Cargo02_EP1","M113_Cargo02_EP1","M113_Cargo02_EP1","M113_Cargo02_EP1","M113_Cargo02_EP1","M113_Cargo02_EP1"};
		...
		{
			tex[] = {};
			mat[] = {"Ca\Tracked_d_BAF\Data\Warrior_ext.rvmat","Ca\Tracked_d_BAF\Data\Warrior_ext_damage.rvmat","Ca\Tracked_d_BAF\Data\Warrior_ext_destruct.rvmat","Ca\Tracked_d_BAF\Data\Warrior_track.rvmat","Ca\Tracked_E\M1_Abrams\Data\m1_abrams_track_metal_damage.rvmat","Ca\Tracked_E\M1_Abrams\Data\m1_abrams_track_metal_destruct.rvmat"};
		};
		soundGear[] = {"",5.6234134e-005,1};
		soundGetIn[] = {"Ca\sounds_baf\tracked\ext_door",0.56234133,1};
		soundGetOut[] = {"Ca\sounds_baf\tracked\ext_door",0.56234133,1,50};
		soundEngineOnInt[] = {"Ca\sounds_baf\tracked\int_start",3.1622777,1.0};
		soundEngineOnExt[] = {"Ca\sounds_baf\tracked\ext_start",5.623413,1.0,400};
		soundEngineOffInt[] = {"Ca\sounds_baf\tracked\int_stop",3.1622777,1.0};
		soundEngineOffExt[] = {"Ca\sounds_baf\tracked\ext_stop",5.623413,1.0,400};
		...
		class SoundEvents
		{
			...
			{
				sound[] = {"Ca\sounds_baf\tracked\int_acce",5.623413,1.0};
				limit = "0.15";
				expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[1.5, 5]) min (speed factor[5, 1.5]))";
			};
			class AccelerationOut
			{
				sound[] = {"Ca\sounds_baf\tracked\ext_acce",5.623413,1.0,500};
				limit = "0.15";
		...
		class Sounds: Sounds
		{
			class Engine: Engine
			{
				sound[] = {"Ca\sounds_baf\tracked\ext_engine",10.0,1.0,900};
				frequency = "0.975+(0.05*thrust)";
				volume = "engineOn*camPos*(rpm factor[0.3, 0.9])";
			};
			class IdleOut
			{
				sound[] = {"Ca\sounds_baf\tracked\ext_idle",6.3095737,1.0,400};
				frequency = "1";
				volume = "engineOn*camPos*(rpm factor[0.4, 0.15])";
			};
			class NoiseOut
			{
				sound[] = {"Ca\sounds_baf\tracked\ext_noise2",10.0,1.0,120};
				frequency = "1";
				volume = "camPos*(angVelocity max 0.04)*(speed factor[4, 15])";
			};
			class ThreadsOutH0
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trhard_01",1.7782794,1.0,300};
				frequency = "1";
				volume = "engineOn*camPos*(1-grass)*((rpm factor[0.3, 0.6]) min (rpm factor[0.6, 0.3]))";
			};
			class ThreadsOutH1
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trhard_02",1.7782794,1.0,300};
				frequency = "1";
				volume = "engineOn*camPos*(1-grass)*((rpm factor[0.5, 0.8]) min (rpm factor[0.8, 0.5]))";
			};
			class ThreadsOutH2
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trhard_03",1.7782794,1.0,300};
				frequency = "1";
				volume = "engineOn*camPos*(1-grass)*((rpm factor[0.65, 0.9]) min (rpm factor[0.9, 0.65]))";
			};
			class ThreadsOutH3
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trhard_04",1.7782794,1.0,300};
				frequency = "1";
				volume = "engineOn*camPos*(1-grass)*((rpm factor[0.8, 1.2]) min (rpm factor[1.2, 0.8]))";
			};
			class ThreadsOutH4
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trhard_05",1.7782794,1.0,300};
				frequency = "1";
				volume = "engineOn*camPos*(1-grass)*((rpm factor[1, 1.8]) min (rpm factor[1.8, 1]))";
			};
			class ThreadsOutS0
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trsoft_01",1.7782794,1.0,250};
				frequency = "1";
				volume = "engineOn*camPos*grass*((rpm factor[0.3, 0.6]) min (rpm factor[0.6, 0.3]))";
			};
			class ThreadsOutS1
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trsoft_02",1.7782794,1.0,250};
				frequency = "1";
				volume = "engineOn*camPos*grass*((rpm factor[0.5, 0.8]) min (rpm factor[0.8, 0.5]))";
			};
			class ThreadsOutS2
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trsoft_03",1.7782794,1.0,250};
				frequency = "1";
				volume = "engineOn*camPos*grass*((rpm factor[0.65, 0.9]) min (rpm factor[0.9, 0.65]))";
			};
			class ThreadsOutS3
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trsoft_04",1.7782794,1.0,250};
				frequency = "1";
				volume = "engineOn*camPos*grass*((rpm factor[0.8, 1.2]) min (rpm factor[1.2, 0.8]))";
			};
			class ThreadsOutS4
			{
				sound[] = {"Ca\sounds_baf\tracked\treads\ext_trsoft_05",1.7782794,1.0,250};
				frequency = "1";
