...
//Fri Oct 31 06:07:47 2014 : Source 'file' date Fri Oct 31 06:07:47 2014
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class anims_e : config\wmn\config.bin{
class CfgPatches
{
	class CA_Anims_E_Wmn
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 1.02;
		requiredAddons[] = {"CA_Anims_E","CA_Anims_Wmn"};
	};
};
class CfgMovesBasic
{
...
class CfgMovesWomen: CfgMovesBasic
{
	...
	class States
	{
		...
		{
			soundEnabled = 0;
			ConnectTo[] = {"AmovPercMstpSnonWnonDnon",0.02,"CwmnPerc_stani1",0.02,"CwmnPerc_stani2",0.02,"CwmnPerc_stani4",0.02,"CwmnPerc_stani5",0.02,"CwmnPerc_stani6",0.02,"CwmnPerc_stani7",0.02,"CwmnPerc_stani8",0.02};
		...
		class AmovPercMwlkSoldDf: AmovPercMstpSoldDnon
		{
			...
			soundOverride = "wlk";
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMwlkSoldDfl",0.02,"AmovPercMstpSoldDnon",0.02,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMrunSoldDf",0.025,"AmovPercMwlkSoldDfr",0.02};
		};
		class AmovPercMwlkSoldDfl: AmovPercMwlkSoldDf
		{
			...
			speed = 0.212389;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMwlkSoldDl",0.02,"AmovPercMwlkSoldDf",0.02,"AmovPercMstpSoldDnon",0.02,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMrunSoldDf",0.025};
		};
		...
		class AmovPercMwlkSoldDb: AmovPercMwlkSoldDf
		{
			...
			speed = 0.179104;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMwlkSoldDbl",0.02,"AmovPercMstpSoldDnon",0.02,"AmovPercMwlkSoldDbr",0.02,"AdthPercMstpSnonWnonDnon_1",0.01};
		};
		class AmovPercMwlkSoldDbr: AmovPercMwlkSoldDf
		{
			...
			speed = 0.226415;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMwlkSoldDb",0.02,"AmovPercMstpSoldDnon",0.02,"AmovPercMwlkSoldDr",0.02,"AdthPercMstpSnonWnonDnon_1",0.01};
		};
		class AmovPercMwlkSoldDr: AmovPercMwlkSoldDf
		{
			...
			speed = 0.192;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSoldDnon",0.02,"AmovPercMwlkSoldDbr",0.02,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMwlkSoldDfr",0.02};
		};
		class AmovPercMwlkSoldDfr: AmovPercMwlkSoldDf
		{
			...
			speed = 0.218182;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMwlkSoldDf",0.02,"AmovPercMstpSoldDnon",0.02,"AmovPercMwlkSoldDr",0.02,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMrunSoldDf",0.025};
		};
		class AmovPercMrunSoldDf: AmovPercMwlkSoldDf
		{
			...
			InterpolateTo[] = {"AmovPercMwlkSoldDfl",0.025,"AmovPercMwlkSoldDf",0.025,"AmovPercMstpSoldDnon",0.02,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMwlkSoldDfr",0.025};
		};
		...
		class ActsPercMstp_HenFeeding1: CutSceneAnimationBase
		{
			...
			speed = 0.040377;
			ConnectTo[] = {"ActsPercMstp_HenFeeding2",0.02,"ActsPercMstp_HenFeeding3",0.02};
		...
		class LadderCivilStatic: StandBase
		{
			...
			InterpolateTo[] = {"LadderCivilDownLoop",0.1,"LadderCivilUpLoop",0.1};
		};
		...
		class LadderCivilUpLoop: LadderCivilStatic
		{
			...
			speed = 2.5;
			ConnectTo[] = {};
			InterpolateTo[] = {"LadderCivilDownLoop",0.1,"LadderCivilUpOff",0.1,"LadderCivilStatic",0.1};
		};
		class LadderCivilDownLoop: LadderCivilUpLoop
		{
			...
			speed = 2.5;
			ConnectTo[] = {};
			InterpolateTo[] = {"LadderCivilUpLoop",0.1,"LadderCivilDownOff",0.1,"LadderCivilStatic",0.1};
		};
		...
		class AswmPercMstpDnon: AmovPercMstpSnonWnonDnon
		{
			...
			soundEdge[] = {0.5};
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01,"AswmPercMstpDnon_AswmPercMstpDf",0.01,"AdthPswmMstp_Slapani",0.01};
		};
		...
		class AswmPercMstpSnonWnonDf: AswmPercMstpDnon
		{
			...
			speed = 0.555556;
			ConnectTo[] = {};
			InterpolateTo[] = {"AswmPercMstpDf_AswmPercMstpDnon",0.01,"AdthPswmMstp_Plavani",0.01};
		};
		...
		class ActsPsitMstp_StopS0: CutSceneAnimationBase
		{
			...
			soundOverride = "";
			ConnectTo[] = {"ActsPsitMstp_cekani2",0.02,"ActsPsitMstp_cekani1",0.02,"ActsPsitMstp_OtreniCela",0.02,"ActsPsitMstp_cekani6",0.02,"ActsPsitMstp_Stop",0.02,"ActsPsitMstp_idleLoop",0.02,"ActsPsitMstp_cekani3",0.02,"ActsPsitMstp_Smoking",0.02,"ActsPsitMstp_cekani4",0.02,"ActsPsitMstp_cekani5",0.02};
			InterpolateTo[] = {"AdthPsitMstp_Death1",0.01,"AdthPsitMstp_Death3",0.01,"AdthPsitMstp_Death2",0.01,"AdthPsitMstp_Death4fallground",0.01};
		};
		class ActsPsitMstp_Stop: CutSceneAnimationBase
		{
			soundOverride = "";
			ConnectTo[] = {"ActsPsitMstp_cekani2",0.025,"ActsPsitMstp_cekani1",0.025,"ActsPsitMstp_OtreniCela",0.025,"ActsPsitMstp_cekani6",0.025,"ActsPsitMstp_StopS0",0.025,"ActsPsitMstp_idleLoop",0.025,"ActsPsitMstp_cekani3",0.025,"ActsPsitMstp_Smoking",0.025,"ActsPsitMstp_cekani4",0.025,"ActsPsitMstp_StandUp",0.02,"ActsPsitMstp_cekani5",0.025};
			InterpolateTo[] = {"AdthPsitMstp_Death1",0.01,"AdthPsitMstp_Death3",0.01,"AdthPsitMstp_Death2",0.01,"AdthPsitMstp_Death4fallground",0.01};
		};
		...
		class ActsPsitMstp_OtreniCela: ActsPsitMstp_StopS0
		{
			...
			InterpolateTo[] = {"ActsPsitMstp_Stop",0.025,"AdthPsitMstp_Death1",0.01,"AdthPsitMstp_Death3",0.01,"AdthPsitMstp_Death2",0.01,"AdthPsitMstp_Death4fallground",0.01};
		};
		...
		class AmovPerc_joggingSlower: AmovPerc_joggingPause
		{
			...
			actions = "WmnStandAction";
			soundOverride = "wlk";
			ConnectTo[] = {"AmovPerc_j_JoggingExercisesA",0.01,"AmovPerc_j_JoggingExercisesB",0.01,"AmovPerc_j_JoggingExercisesC",0.01,"AmovPerc_joggingPause",0.01};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01,"AmovPerc_joggingSlowerS0",0.01,"AmovPercMrunSnonWnonDf",0.01,"AmovPercMwlkSnonWnonDf_A",0.01,"AmovPercMwlkSnonWnonDfr",0.01,"AmovPercMwlkSnonWnonDfl",0.01,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		...
		class AmovPsqtMstpSnonDnon: AmovPercMstpSnonWnonDnon
		{
			...
			InterpolateTo[] = {"AmovPsqtMstpSnonDnon_turnR",0.02,"AmovPsqtMstpSnonDnon_turnL",0.02,"AdthPknlMstpSnonWnonDnon_1",0.01};
		};
		...
		class ActsPercMstpSnon_damsel_idle01: ActsPercMstpSnon_damsel
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_rouge",0.02,"ActsPercMstpSnon_damsel_powder",0.02,"ActsPercMstpSnon_damsel_idle02",0.02,"ActsPercMstpSnon_damsel_idle03",0.02,"ActsPercMstpSnon_damsel_smoking",0.02};
		...
		class ActsPercMstpSnon_damsel_idle02: ActsPercMstpSnon_damsel_idle01
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_idle01",0.02,"ActsPercMstpSnon_damsel_rouge",0.02,"ActsPercMstpSnon_damsel_powder",0.02,"ActsPercMstpSnon_damsel_idle03",0.02,"ActsPercMstpSnon_damsel_smoking",0.02};
			InterpolateTo[] = {"ActsPercMstpSnon_damsel",0.02,"ActsPercMstpSnonWnonDnon_AmovPercMstpSnon_damsel",0.02,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		class ActsPercMstpSnon_damsel_idle03: ActsPercMstpSnon_damsel_idle01
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_idle01",0.02,"ActsPercMstpSnon_damsel_rouge",0.02,"ActsPercMstpSnon_damsel_powder",0.02,"ActsPercMstpSnon_damsel_idle02",0.02,"ActsPercMstpSnon_damsel_smoking",0.02};
			InterpolateTo[] = {"ActsPercMstpSnon_damsel",0.02,"ActsPercMstpSnonWnonDnon_AmovPercMstpSnon_damsel",0.02,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		class ActsPercMstpSnon_damsel_rouge: ActsPercMstpSnon_damsel_idle01
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_idle01",0.02,"ActsPercMstpSnon_damsel_powder",0.02,"ActsPercMstpSnon_damsel_idle02",0.02,"ActsPercMstpSnon_damsel_idle03",0.02,"ActsPercMstpSnon_damsel_smoking",0.02};
			InterpolateTo[] = {"ActsPercMstpSnon_damsel",0.02,"ActsPercMstpSnonWnonDnon_AmovPercMstpSnon_damsel",0.02,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		class ActsPercMstpSnon_damsel_powder: ActsPercMstpSnon_damsel_idle01
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_idle01",0.02,"ActsPercMstpSnon_damsel_rouge",0.02,"ActsPercMstpSnon_damsel_idle02",0.02,"ActsPercMstpSnon_damsel_idle03",0.02,"ActsPercMstpSnon_damsel_smoking",0.02};
			InterpolateTo[] = {"ActsPercMstpSnon_damsel",0.02,"ActsPercMstpSnonWnonDnon_AmovPercMstpSnon_damsel",0.02,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		...
		class ActsPercMstpSnon_damsel_smoking: ActsPercMstpSnon_damsel_idle01
		{
			...
			ConnectTo[] = {"ActsPercMstpSnon_damsel_idle01",0.02,"ActsPercMstpSnon_damsel_rouge",0.02,"ActsPercMstpSnon_damsel_powder",0.02,"ActsPercMstpSnon_damsel_idle02",0.02,"ActsPercMstpSnon_damsel_idle03",0.02};
			InterpolateTo[] = {"ActsPercMstpSnon_damsel",0.02,"ActsPercMstpSnonWnonDnon_AmovPercMstpSnon_damsel",0.02,"AdthPercMstpSnonWnonDnon_2",0.01};
		};
		...
		class AmovPercMwlkSnonWnonDf_A: AmovPercMstpSnonWnonDnon
		{
			...
			soundOverride = "wlk";
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMrunSnonWnonDf",0.015,"AmovPerc_joggingSlower",0.01,"AmovPercMwlkSnonWnonDfr",0.01,"AmovPercMwlkSnonWnonDfl",0.01};
		};
		...
		class AmovPercMrunSnonWnonDf_panic: AmovPercMrunSnonWnonDf
		{
			...
			duty = 1.0;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01,"AdthPercMstpSnonWnonDnon_1",0.01,"AmovPercMrunSnonWnonDf",0.0};
		};
		...
		class AidlPsqtMstpSnonDnon: AinvPsqtMstpSnonDnonS0
		{
			...
			InterpolateTo[] = {"AmovPsqtMstpSnonDnon",0.02,"AdthPknlMstpSnonWnonDnon_1",0.01};
		};
		...
		class womanBoundCaptive_loop: CutSceneAnimationBase
		{
			variantAfter[] = {1,1,1};
			variantsAI[] = {"womanBoundCaptive_loop1",0.25,"womanBoundCaptive_loop2",0.25,"womanBoundCaptive_loop3",0.25,"womanBoundCaptive_loop4",0.25};
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_loop";
			actions = "WmnSitAction_womanBoundCaptive";
			equivalentTo = "womanBoundCaptive_loop";
			ConnectTo[] = {"womanBoundCaptive_loop1",0.01,"womanBoundCaptive_loop2",0.01,"womanBoundCaptive_loop3",0.01,"womanBoundCaptive_loop4",0.01,"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
			InterpolateTo[] = {"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
		};
		class womanBoundCaptive_loop1: womanBoundCaptive_loop
		{
			looped = 0;
			speed = 0.028235;
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_loop1";
			ConnectTo[] = {"womanBoundCaptive_loop",0.01,"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
			InterpolateTo[] = {"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
		};
		class womanBoundCaptive_loop2: womanBoundCaptive_loop
		{
			looped = 0;
			speed = 0.04428;
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_loop2";
			ConnectTo[] = {"womanBoundCaptive_loop",0.01,"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
			InterpolateTo[] = {"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
		};
		class womanBoundCaptive_loop3: womanBoundCaptive_loop
		{
			looped = 0;
			speed = 0.092308;
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_loop3";
			ConnectTo[] = {"womanBoundCaptive_loop",0.01,"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
			InterpolateTo[] = {"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
		};
		class womanBoundCaptive_loop4: womanBoundCaptive_loop
		{
			looped = 0;
			speed = 0.114286;
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_loop4";
			ConnectTo[] = {"womanBoundCaptive_loop",0.01,"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
			InterpolateTo[] = {"womanBoundCaptive_unaErc",0.01,"womanBoundCaptive_death",0.01};
		};
		class womanBoundCaptive_unaErc: CutSceneAnimationBase
		{
			speed = 0.258621;
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_unaErc";
			looped = 0;
			interpolationRestart = 1;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01};
		};
		class womanBoundCaptive_death: AdthPsitMstp_Death1
		{
			equivalentTo = "";
			file = "\CA\Anims_E\data\Anim\wmn\cts\CE6_captives\womanBoundCaptive_death";
			speed = 0.5;
			ConnectTo[] = {};
			InterpolateTo[] = {};
		};
	...
	class Actions
	{
		...
		class WmnSitAction_womanBoundCaptive: WmnStandAction
		{
			Stop = "womanBoundCaptive_loop";
			StopRelaxed = "womanBoundCaptive_loop";
			Default = "womanBoundCaptive_loop";
			Crouch = "AmovPsqtMstpSnonDnon";
			Civil = "";
			CanNotMove = "";
			Die = "womanBoundCaptive_death";
		};
