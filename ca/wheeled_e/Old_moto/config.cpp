...
//Class wheeled_e : Old_moto\config.bin{
class CfgPatches
{
	class CAWheeled_E_Old_moto
	{
		units[] = {"Old_moto_TK_Civ_EP1"};
		weapons[] = {};
		requiredVersion = 1.02;
		requiredAddons[] = {"CAWheeled_E","CAWheeled3"};
	};
};
class CfgVehicles
{
	...
	class Old_moto_base: Motorcycle
	{
		...
		{
			tex[] = {};
			mat[] = {"Ca\wheeled_E\Old_moto\Data\Old_moto.rvmat","Ca\wheeled_E\Old_moto\Data\Old_moto_damage.rvmat","Ca\wheeled_E\Old_moto\Data\Old_moto_destruct.rvmat","Ca\Ca_E\data\default.rvmat","Ca\Ca_E\data\default.rvmat","Ca\Ca_E\data\default_destruct.rvmat"};
		};
		hiddenSelections[] = {"camo1","camo2"};
		hiddenSelectionsTextures[] = {"\ca\wheeled_e\old_moto\data\old_moto_co.paa","ca\wheeled_e\old_moto\data\old_moto_alfa_co.paa"};
	};
