...
//Fri Oct 31 06:02:19 2014 : Source 'file' date Fri Oct 31 06:02:19 2014
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class dubbingradio_acr : config.bin{
class CfgPatches
{
	class CA_DubbingRadio_ACR
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 1.52;
		requiredAddons[] = {"CA_Dubbing","CA_E","CA_DubbingRadio_E"};
	};
};
class CfgVoice
{
	...
	{
		directories[] = {"\ca\dubbingradio_ACR\RADIO\Male01CZ\","\ca\dubbingradio_ACR\RADIO\Male01CZ\"};
		voiceType = "Male01";
		scope = 2;
	};
	class Male02CZ_ACR: CZ_ACR
	{
		directories[] = {"\ca\dubbingradio_ACR\RADIO\Male02CZ\","\ca\dubbingradio_ACR\RADIO\Male02CZ\"};
		voiceType = "Male02";
		scope = 2;
	};
	class Male03CZ_ACR: CZ_ACR
	{
		directories[] = {"\ca\dubbingradio_ACR\RADIO\Male03CZ\","\ca\dubbingradio_ACR\RADIO\Male03CZ\"};
		voiceType = "Male03";
		scope = 2;
	};
	class Male04CZ_ACR: CZ_ACR
	{
		directories[] = {"\ca\dubbingradio_ACR\RADIO\Male04CZ\","\ca\dubbingradio_ACR\RADIO\Male04CZ\"};
		voiceType = "Male04";
		scope = 2;
	};
...
class RadioProtocol_ACR_CZ: RadioProtocolBase
{
	class Words
	{
