...
//Class mp_armory : misc\plasticpole\config.bin{
class CfgPatches
{
	class CAMP_Armory_Misc_Plasticpole
	{
		units[] = {};
		weapons[] = {};
...
class CfgVehicles
{
	...
	class Plastic_Pole_EP1: Small_items_NoInteractive
	{
		expansion = 1;
		scope = 2;
		displayName = "$STR_EP1_MPA_MISC_PLASTICPOLE";
		model = "\Ca\mp_armory\misc\plasticpole\plasticpole.p3d";
