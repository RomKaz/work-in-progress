...
class CfgArmory
{
	class Unlockables
	{
		class BAF
		{
			classes[] = {"BAF_L109A1_HE","BAF_L85A2_RIS_SUSAT","BAF_soldier_MTP","BAF_Asoldier_MTP","BAF_soldier_Medic_MTP","BAF_pilot_MTP","BAF_crewman_MTP","BAF_ATV_D","BAF_soldier_DDPM","BAF_Asoldier_DDPM","BAF_soldier_Medic_DDPM","BAF_pilot_DDPM","BAF_crewman_DDPM","BAF_L85A2_UGL_SUSAT","BAF_soldier_GL_MTP","BAF_soldier_GL_DDPM","BAF_Soldier_spotterN_MTP","BAF_L86A2_ACOG","BAF_soldier_Marksman_MTP","BAF_Offroad_D","BAF_soldier_Marksman_DDPM","CIV_Contractor1_BAF","BAF_Soldier_scout_MTP","BAF_Soldier_scout_DDPM","BAF_L85A2_RIS_ACOG","BAF_L85A2_RIS_Holo","BAF_soldier_L_MTP","BAF_soldier_EN_MTP","BAF_L85A2_UGL_ACOG","BAF_soldier_L_DDPM","BAF_soldier_EN_DDPM","BAF_L85A2_UGL_Holo","BAF_L85A2_RIS_CWS","BAF_Soldier_N_MTP","BAF_Soldier_N_DDPM","BAF_Soldier_AMG_DDPM","BAF_soldier_spotter_MTP","BAF_Soldier_FAC_MTP","BAF_soldier_spotter_DDPM","BAF_Soldier_FAC_DDPM","BAF_soldier_TL_MTP","BAF_soldier_TL_DDPM","CIV_Contractor2_BAF","BAF_L2A1_ACOG_tripod","BAF_L2A1_ACOG_minitripod","BAF_L2A1_Tripod_D","BAF_L2A1_Minitripod_W","BAF_L2A1_Tripod_W","BAF_L2A1_Minitripod_D","BAF_Merlin_HC3_D","BAF_GPMG_Minitripod_D","BAF_GMG_ACOG_minitripod","BAF_GPMG_Minitripod_W","BAF_GMG_Tripod_D","BAF_GMG_Tripod_W","BAF_soldier_AA_MTP","BAF_soldier_AA_DDPM","BAF_LRR_scoped","BAF_soldier_Sniper_MTP","BAF_soldier_AHAA_MTP","BAF_soldier_Sniper_DDPM","BAF_soldier_AHAA_DDPM","BAF_L110A1_Aim","BAF_soldier_AR_MTP","BAF_soldier_AR_DDPM","BAF_L7A2_GPMG","BAF_soldier_MG_MTP","BAF_soldier_MG_DDPM","BAF_soldier_AAR_MTP","BAF_soldier_AMG_MTP","BAF_soldier_AAR_DDPM","BAF_soldier_SL_MTP","BAF_Soldier_N_W","BAF_soldier_SL_DDPM","BAF_Soldier_AAA_DDPM","BAF_NLAW_Launcher","BAF_soldier_AT_MTP","BAF_soldier_HAT_MTP","BAF_soldier_AT_DDPM","BAF_soldier_HAT_DDPM","BAF_soldier_AAT_MTP","BAF_soldier_AHAT_MTP","BAF_soldier_AAT_DDPM","BAF_soldier_AHAT_DDPM","BAF_Soldier_AAA_MTP","BAF_AS50_scoped","BAF_soldier_SniperH_MTP","BAF_Soldier_Officer_DDPM","BAF_AS50_TWS","BAF_soldier_Officer_MTP","BAF_soldier_SniperN_MTP","BAF_soldier_w","BAF_Asoldier_w","BAF_soldier_Medic_w","BAF_pilot_w","BAF_crewman_w","BAF_ATV_w","BAF_Jackal2_L2A1_D","BAF_soldier_GL_w","BAF_soldier_Marksman_w","BAF_Offroad_w","BAF_soldier_L_w","BAF_soldier_EN_w","BAF_Soldier_N_MTP","BAF_soldier_spotter_w","BAF_Soldier_FAC_w","BAF_Soldier_spotterN_W","BAF_soldier_TL_MTP","BAF_L2A1_ACOG_tripod_w","BAF_L2A1_ACOG_minitripod_w","BAF_Jackal2_GMG_D","BAF_GPMG_Minitripod_D","BAF_GMG_ACOG_minitripod","BAF_soldier_AA_w","SUV_PMC_BAF","BAF_LRR_scoped_W","BAF_soldier_Sniper_w","BAF_soldier_AHAA_w","BAF_soldier_AR_w","BAF_Soldier_scout_W","BAF_soldier_MG_w","BAF_soldier_AAR_w","BAF_soldier_AMG_w","BAF_soldier_SL_w","BAF_Soldier_TL_W","BAF_soldier_AT_w","BAF_soldier_HAT_w","BAF_soldier_AAT_w","BAF_soldier_AHAT_w","BAF_Soldier_AAA_W","BAF_soldier_SniperH_w","BAF_soldier_Officer_w","BAF_soldier_SniperN_w","BAF_Jackal2_L2A1_w","BAF_Jackal2_GMG_w","AW159_Lynx_BAF","BAF_Apache_AH1_D","BAF_FV510_D","CH_47F_BAF","BAF_FV510_W","BAF_ied_v1","BAF_ied_v2","BAF_ied_v3","BAF_ied_v4"};
...
class CfgAddons
{
	...
	class PreloadAddons
	{
		class CA_BAF
		{
			list[] = {"CAAir_BAF","CAAir_BAF_CH_47F","CA_Dubbing_Baf","CACharacters_BAF","CACharacters_W_BAF","CALanguage_Baf","CALanguageMissions_baf","CA_Missions_BAF","CA_Sounds_Baf","CATracked_BAF","CATracked_W_BAF","CAWeapons_BAF","CAWheeled_D_BAF","CAWheeled_W_BAF","CA_Missions_BAF_Templates_SecOps","CA_BAF","Shapur_BAF","CACharacters_BAF_Head"};
		};
	};
};
...
class CfgFactionClasses
{
	class BIS_BAF
	{
		displayName = "$STR_BAF_CFGFACTIONCLASSES_BIS_BAF0";
		priority = 9;
		side = 1;
	};
	class PMC_BAF
	{
		displayName = "$STR_BAF_CFGFACTIONCLASSES_PMC_BAF0";
		priority = 9;
		side = 2;
	};
};
...
class CfgMusic
{
	class BAF_Track01
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track01_Crimson_Lance.ogg",1,1};
		duration = 140;
	};
	class BAF_Track02
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track02_Drums.ogg",1,1};
		duration = 43;
	};
	class BAF_Track03
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track03_Jackals.ogg",1,1};
		duration = 54;
	};
	class BAF_Track04
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track04_Through_The_Valley.ogg",1,1};
		duration = 44;
	};
	class BAF_Track05
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track05_Utrinque_Paratus.ogg",1,1};
		duration = 44;
	};
	class BAF_Track06
	{
		...
		sound[] = {"\Ca\Data_baf\Music\BAF_Track06_War_Pipes.ogg",1,1};
		duration = 65;
	};
};
class CfgSounds
{
	class mortar1
	{
		expansion = 2;
		name = "Mortar 1";
		sound[] = {"\ca\data_baf\Music\mortar1.ogg",0.56234133,1};
		titles[] = {};
	};
	class missile_impact
	{
		expansion = 2;
		name = "misile impact";
		sound[] = {"Ca\sounds\Weapons\explosions\explosion_large1",100000,1,1800};
		titles[] = {};
	};
	class missile_inbound
	{
		...
		sound[] = {"Ca\sounds_baf\air\int-alarm_loop",3.1622777,4};
		titles[] = {};
	};
	class chopper_crash
	{
		expansion = 2;
		name = "Chopper Crash";
		sound[] = {"\ca\data_baf\Music\crash.ogg",100,1};
		titles[] = {};
	};
};
//};
