...
//Class characters_w_baf : config.bin{
class CfgPatches
{
	class CACharacters_W_BAF
	{
		units[] = {"BAF_soldier_W","BAF_Asoldier_W","BAF_soldier_GL_W","BAF_soldier_AAR_W","BAF_soldier_AMG_W","BAF_soldier_AAT_W","BAF_soldier_AHAT_W","BAF_soldier_AHAA_W","BAF_soldier_L_W","BAF_soldier_Officer_W","BAF_soldier_SL_W","BAF_soldier_TL_W","BAF_soldier_AR_W","BAF_soldier_MG_W","BAF_soldier_AT_W","BAF_soldier_AA_W","BAF_soldier_HAT_W","BAF_soldier_Marksman_W","BAF_soldier_Sniper_W","BAF_soldier_SniperH_W","BAF_soldier_SniperN_W","BAF_soldier_spotter_W","BAF_soldier_Medic_W","BAF_Soldier_FAC_W","BAF_soldier_EN_W","BAF_pilot_W","BAF_creWman_W"};
		Weapons[] = {};
		requiredVersion = 1.54;
		requiredAddons[] = {"CACharacters_BAF"};
	};
};
...
class CfgVehicles
{
	...
	class BAF_Soldier_scout_W: BAF_Soldier_scout_MTP
	{
		hiddenSelectionsTextures[] = {"\ca\characters_W_baf\data\camo_dpm_co.paa","\ca\characters_W_baf\data\armour_dpm_co.paa","\ca\characters_W_baf\data\equip_dpm_co.paa"};
		vehicleClass = "MenW";
		Weapons[] = {"BAF_LRR_scoped_W","NVGoggles","ThroW","Put","ItemMap","ItemCompass","ItemWatch","ItemRadio","Binocular_Vector","ItemGPS","Colt1911"};
		respaWnWeapons[] = {"BAF_LRR_scoped_W","NVGoggles","ThroW","Put","ItemMap","ItemCompass","ItemWatch","ItemRadio","Binocular_Vector","ItemGPS","Colt1911"};
	};
