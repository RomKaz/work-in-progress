...
//Fri Oct 31 06:07:22 2014 : Source 'file' date Fri Oct 31 06:07:22 2014
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class Woodland_ACR : config.bin{
class CfgPatches
{
	class Woodland_ACR
	{
...
class CfgWorlds
{
	...
	class Woodland_ACR: CAWorld
	{
		access = 3;
		worldId = 4;
		cutscenes[] = {"Woodland_ACR_Intro1"};
		description = "$STR_ACR_DN_MAP_BOHEMIA";
		icon = "";
		worldName = "\ca\Bohemia\Woodland_ACR.wrp";
		pictureMap = "";
		pictureShot = "\ca\Bohemia\data\ui_selectisland_Bohemia_ca.paa";
		plateFormat = "ML$ - #####";
		...
		{
			satellite = "ca\Bohemia\data\s_satout_co.paa";
			enableTerrainSynth = 1;
			class Layers
			{
				class Layer0
				{
					nopx = "ca\Bohemia\data\wl_trava1_detail_nopx.paa";
					texture = "ca\Bohemia\data\wl_trava1_detail_co.paa";
				};
			};
		};
		class Grid: Grid
		...
		noDetailDist = 40;
		fullDetailDist = 15;
		midDetailTexture = "ca\Bohemia\data\wl_trava1_mco.paa";
...
class CfgMissions
{
	class Cutscenes
	{
		class Woodland_ACR_Intro1
		{
			directory = "ca\Bohemia\data\scenes\intro.Woodland_ACR";
		};
	};
};
class CfgSurfaces
