...
//Class air_d_baf : ch47\config.bin{
class CfgPatches
{
...
class CfgVehicles
{
	...
	class CH_47F_BAF: CH_47F_EP1
	{
		...
		soundEngineOnInt[] = {"Ca\sounds_baf\air\uk_start_int_1",0.1,0.9};
		soundEngineOnExt[] = {"Ca\sounds_baf\air\uk_start_ext_1",0.56234133,0.9,800};
		soundEngineOffInt[] = {"\Ca\sounds_baf\air\uk_stop_int_1",0.1,0.9};
		soundEngineOffExt[] = {"Ca\sounds_baf\air\uk_stop_ext_2",0.56234133,0.9,800};
		...
		class Sounds
		{
			class Engine
			{
				sound[] = {"Ca\sounds_baf\air\uk_engine_ext_3",3.1622777,0.8,1000};
				frequency = "rotorSpeed";
				volume = "camPos*((rotorSpeed-0.72)*4)";
			};
			class RotorLowOut
			{
				sound[] = {"\Ca\sounds_baf\air\uk_rotor_4h_swist",3.1622777,1,1200};
				frequency = "rotorSpeed";
			...
			class EngineIn
			{
				sound[] = {"\Ca\sounds_baf\air\uk_engine_int_1",0.56234133,0.8};
				frequency = "rotorSpeed";
				volume = "(1-camPos)*((rotorSpeed-0.75)*4)";
			};
			class RotorLowIn
			{
				sound[] = {"Ca\sounds_baf\air\uk_rotor_4l_int",1.7782794,0.8};
				frequency = "rotorSpeed";
				volume = "2*(1-camPos)*((rotorSpeed factor[0.3, 1.1]) min (rotorSpeed factor[1.1, 0.3]))";
			};
			class RotorHighIn
			{
				sound[] = {"Ca\sounds_baf\air\uk_rotor_4h_int",1.7782794,0.8};
				frequency = "rotorSpeed";
