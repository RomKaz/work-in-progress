...
class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		class AW159_Cargo_BAF: Crew
		{
			...
			connectTo[] = {"AW159_KIA_Cargo_BAF",1};
			speed = 1e+010;
		};
		...
		class AW159_Pilot_BAF: Crew
		{
			...
			connectTo[] = {"AW159_KIA_Pilot_BAF",1};
			speed = 1e+010;
		};
...
class CfgPatches
{
	class CAAir_BAF
	{
		units[] = {"CH_47F_BAF","AW159_Lynx_BAF","BAF_Apache_AH1_D","BAF_Merlin_HC3_D"};
		weapons[] = {};
		requiredVersion = 1.54;
		requiredAddons[] = {"CACharacters_E","CAWeapons_E","CA_Anims_Char","CAAir","CAAir2","CA_BAF","CACharacters_BAF","CAWeapons_BAF","CAAir_E","CAAir_E_CH_47F","CAAir_E_AH64D"};
	};
};
class CfgVehicles
{
	...
	class BAF_Apache_AH1_D: AH64D_EP1
	{
		...
		accuracy = 0.5;
		crew = "BAF_Pilot_MTP";
		typicalCargo[] = {"BAF_Pilot_MTP","BAF_Pilot_MTP"};
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				maxTurn = 120;
				initTurn = 0;
				weapons[] = {"M230","CRV7_HEPD","CRV7_FAT","HellfireLauncher"};
				magazines[] = {"1200Rnd_30x113mm_M789_HEDP","6Rnd_CRV7_HEPD","6Rnd_CRV7_FAT","8Rnd_Hellfire"};
				enableManualFire = 1;
				radarType = 4;
	...
	class AW159_Lynx_BAF: Helicopter
	{
		...
		soundEngineOnInt[] = {"Ca\sounds_baf\air\uk_start_int_1",0.1,1.0};
		soundEngineOnExt[] = {"Ca\sounds_baf\air\uk_start_ext_1",0.56234133,1.0,800};
		soundEngineOffInt[] = {"\Ca\sounds_baf\air\uk_stop_int_1",0.1,1.0};
		soundEngineOffExt[] = {"Ca\sounds_baf\air\uk_stop_ext_2",0.56234133,1.0,800};
		...
		class Sounds
		{
			class Engine
			{
				sound[] = {"Ca\sounds_baf\air\uk_engine_ext_2",3.1622777,1.2,1000};
				frequency = "rotorSpeed";
				volume = "camPos*((rotorSpeed-0.72)*4)";
			};
			class RotorLowOut
			{
				sound[] = {"\Ca\sounds_baf\air\uk_rotor_4h",3.1622777,1.1,1200};
				frequency = "rotorSpeed";
			...
			class RotorHighOut
			{
				sound[] = {"\Ca\sounds_baf\air\uk_rotor_4h_swist",1.7782794,1.1,1300};
				frequency = "rotorSpeed";
			...
			class EngineIn
			{
				sound[] = {"\Ca\sounds_baf\air\uk_engine_int_2",0.56234133,1.2};
				frequency = "rotorSpeed";
				volume = "(1-camPos)*((rotorSpeed-0.75)*4)";
			};
			class RotorLowIn
			{
				sound[] = {"Ca\sounds_baf\air\uk_rotor_4h_int",1.0,1.1};
				frequency = "rotorSpeed";
				volume = "2*(1-camPos)*((rotorSpeed factor[0.3, 1.1]) min (rotorSpeed factor[1.1, 0.3]))";
			};
			class RotorHighIn
			{
				sound[] = {"Ca\sounds_baf\air\uk_rotor_4h_int",3.1622777,1.1};
				frequency = "rotorSpeed";
	...
	class BAF_Merlin_HC3_D: Helicopter
	{
		...
		magazines[] = {"120Rnd_CMFlareMagazine","120Rnd_CMFlareMagazine","120Rnd_CMFlareMagazine"};
