...
//Fri Oct 31 06:13:13 2014 : Source 'file' date Fri Oct 31 06:13:13 2014
...
enum {
	...
	cmd_reply_fail = 65,
	cmd_report = 69,
	cmd_radio_custom_2 = 88,
	cmd_unit_10 = 106,
	cmd_select_yellow = 115,
	cmd_vehicle_4 = 119,
	cmd_vehicle_10 = 125,
	cmd_mp_channel_side = 130,
	cmd_deselect_team_from_bar = 154,
	OrdinalEnum = 166,
	_windowborder = 1,
	cmd_expect = 11,
	cmd_watch_around = 29,
	...
	cmd_radio_hotel = 61,
	cmd_radio_juliet = 63,
	cmd_reply_injured = 79,
	cmd_radio_custom_3 = 89,
	cmd_unit_11 = 107,
	cmd_vehicle_5 = 120,
	cmd_vehicle_11 = 126,
	cmd_hc_select_team_from_bar = 164,
	cmd_stop = 10,
	cmd_loose_form = 23,
	cmd_stealth = 32,
	cmd_team_yellow = 47,
	cmd_radio_india = 62,
	cmd_reply_ammo_low = 77,
	cmd_radio_custom_4 = 90,
	cmd_unit_12 = 108,
	cmd_vehicle_6 = 121,
	cmd_vehicle_12 = 127,
	cmd_mp_channel_vehicle = 133,
	_yinit = 0,
	cmd_aware = 34,
	cmd_safe = 35,
	cmd_support_done = 85,
	cmd_radio_custom_5 = 91,
	cmd_my_vehicle = 110,
	cmd_select_main = 111,
	cmd_vehicle_7 = 122,
	cmd_conversation = 134,
	cmd_stop_auto = 136,
	cmd_join_all = 155,
	cmd_switch_to_selected = 157,
	cmd_form_stagcol = 14,
	cmd_engage = 22,
	cmd_heal = 36,
	cmd_team_main = 43,
	cmd_radio_bravo = 55,
	cmd_reply_copy = 66,
	cmd_radio_custom_6 = 92,
	cmd_vehicle_8 = 123,
	cmd_single_units = 128,
	cmd_getin_auto = 138,
	cmd_hold_fire_auto = 147,
	cmd_radio_alpha = 54,
	cmd_reply_done = 64,
	cmd_reply_killed = 76,
	cmd_radio_custom_7 = 93,
	cmd_unit_1 = 97,
	cmd_vehicle_9 = 124,
	cmd_open_fire_auto = 146,
	cmd_getin = 0,
	cmd_next_waypoint = 7,
	cmd_pos_auto = 42,
	cmd_reply_repeat = 67,
	cmd_reply_one_less = 73,
	cmd_support_refuel = 84,
	cmd_radio_custom = 86,
	cmd_radio_custom_8 = 94,
	cmd_unit_2 = 98,
	cmd_units_all = 109,
	cmd_select_green = 113,
	cmd_mp_channel_command = 131,
	cmd_mp_channel_group = 132,
	_hintsw = 25,
	_hintsh = 4,
	_tsheight = 38,
	cmd_action = 2,
	cmd_form_echleft = 16,
	cmd_combat = 33,
	cmd_repair_vehicle = 37,
	cmd_team_green = 45,
	cmd_assign_main = 48,
	cmd_team_dissolve = 53,
	cmd_reply_hit = 72,
	cmd_reply_firenotready = 75,
	cmd_support_ambulance = 81,
	cmd_radio_custom_9 = 95,
	cmd_unit_3 = 99,
	cmd_select_red = 112,
	cmd_rearm_auto = 139,
	cmd_fire_at_position_auto = 141,
	cmd_join_auto = 145,
	_hintsx = 0,
	cmd_form_wedge = 15,
	cmd_assign_green = 50,
	cmd_unit_4 = 100,
	cmd_attack_auto = 140,
	cmd_switch_to_leader = 156,
	htnone = 0,
	_hintsy = 0,
	_windowheight = 43,
	_availableitemsheight = 76,
	cmd_join = 9,
	cmd_form_diamond = 20,
	cmd_keep_form = 24,
	cmd_suppress = 38,
	cmd_reply_under_fire = 71,
	cmd_support_repair = 82,
	cmd_support_rearm = 83,
	cmd_unit_5 = 101,
	cmd_getout = 1,
	cmd_flank_right = 6,
	cmd_form_column = 13,
	cmd_radio_foxtrot = 59,
	cmd_reply_fuel_low = 78,
	cmd_unit_6 = 102,
	cmd_complex_command = 148,
	cmd_select_unit_from_bar = 149,
	cmd_notarget = 158,
	cmd_hc_select_auto = 159,
	cmd_hc_deselect_unit_from_bar = 163,
	htmoveright = 3,
	sptpercents = 1,
	_xspacing = 0,
	_tsy = 29,
	...
	cmd_radio_echo = 58,
	cmd_radio_golf = 60,
	cmd_reply_fireready = 74,
	cmd_unit_7 = 103,
	cmd_mp_channel_global = 129,
	cmd_select_vehicle_from_bar = 151,
	cmd_deselect_vehicle_from_bar = 152,
	cmd_hc_select_auto_add = 160,
	htfade = 1,
	htmoveleft = 2,
	_xinit = 0,
	cmd_hide = 8,
	...
	cmd_hold_fire = 25,
	cmd_assign_red = 49,
	cmd_reply_engaging = 70,
	cmd_unit_8 = 104,
	cmd_select_blue = 114,
	cmd_vehicle_1 = 116,
	cmd_deselect_unit_from_bar = 150,
	cmd_hc_deselect_auto = 161,
	sptplain = 0,
	_yspacing = 0,
	cmd_flank_left = 5,
	cmd_open_fire = 26,
	cmd_team_blue = 46,
	cmd_radio_custom_0 = 96,
	cmd_unit_9 = 105,
	cmd_vehicle_2 = 117,
	cmd_select_auto = 142,
	cmd_hc_select_unit_from_bar = 162,
	cmd_hc_deselect_team_from_bar = 165,
	_windowwidth = 59,
	cmd_advance = 3,
	cmd_form_line = 19,
	cmd_watch_dir = 31,
	cmd_pos_middle = 40,
	cmd_assign_yellow = 52,
	cmd_radio_charlie = 56,
	cmd_radio_delta = 57,
	cmd_reply_where_are_you = 68,
	cmd_support_medic = 80,
	cmd_radio_custom_1 = 87,
	cmd_vehicle_3 = 118,
	cmd_move_auto = 135,
	cmd_watch_ctx = 137,
	cmd_select_auto_add = 143,
	cmd_deselect_auto = 144,
	cmd_select_team_from_bar = 153
};
...
class RscIGProgress: RscProgress
{
	...
	colorBar[] = {0.4,0.6745,0.2784,1.0};
...
class RscInGameUI
{
	colorReady[] = {0.4,0.6745,0.2784,1.0};
	...
	{
		idd = 300;
		controls[] = {"CA_Weapon","CA_Mode","CA_Ammo","CA_ValueFuelBackground","CA_ValueFuel","CA_GunnerWeapon","CA_SpeedBackground","CA_TextSpeed","CA_Speed","CA_AltBackground","CA_TextAlt","CA_Alt","CA_HeadingBackground","CA_Heading","CA_ValueArmor","CA_TextFlares","CA_TextFlaresMode","RscTextUAV","TextPosition","Position","TextZoom","Zoom","Time","Date"};
		class CA_Mode: RscIGUIText
		{
			idc = 149;
			style = 0;
...
class RscChatListDefault
{
	...
	colorBackground[] = {0.63,0.63,0.63,0.33};
	colorPlayerBackground[] = {0.19,0.26,0.15,0.0};
	colorGlobalChannel[] = {0.7,0.9,1.0,1.0};
	colorSideChannel[] = {0.27,0.83,0.99,1.0};
	colorCommandChannel[] = {1.0,1.0,0.5,1.0};
	colorGroupChannel[] = {0.85,1.0,0.65,1.0};
	colorVehicleChannel[] = {1.0,0.8,0.0,1.0};
	colorDirectChannel[] = {0.95,0.95,0.95,1.0};
	colorPlayerChannel[] = {0.8,0.7,1.0,1.0};
	colorSystemChannel[] = {0.7,0.7,0.7,1.0};
};
...
class RscTitles
{
	...
	class OptionsAvailable
	{
		...
		controls[] = {"OptionsIcon0","OptionsIcon1","OptionsIcon2","OptionsIcon3","OptionsIcon4","OptionsIcon5","OptionsIcon6","OptionsIcon7","OptionsIcon8","OptionsIcon9","OptionsIcon10","OptionsIcon11","OptionsIcon12","OptionsIcon13","OptionsIcon14","OptionsIcon15","OptionsIcon16","OptionsIcon17"};
		controlsBackground[] = {};
	...
	class SplashCopyright
	{
		...
		controls[] = {"Picture","Text_WWW","Text_Copyright"};
		class Picture: RscPicture
		{
	...
	class RscUnitInfoUAVHeli
	{
		...
		class controls
		{
			...
			class UAV_Frame_0_1: RscText
			{
				...
				linespacing = 1;
				text = "";
				colorBackground[] = {0.4,0.6745,0.2784,1.0};
				style = "0x00 + 0x10 + 0x200";
			};
	...
	class rscAAN
	{
		...
		class ControlsBackground
		{
			...
			class BackgroundBarRed: BackgroundBarWhite
			{
				...
				h = "0.1275 * safezoneH";
				colorBackground[] = {0.29,0,0,"0.6*2"};
			};
		};
		class Controls
		{
	...
	class RscUnitInfoKa137
	{
		...
		class controls
		{
			class RscTextUAV: RscText
			{
				...
				w = 30;
				h = 30;
				colorbackground[] = {0.8275,0.8196,0.1961,0.07};
				type = 0;
				IDC = 1004;
				linespacing = 1;
				text = "";
			...
			class UAV_Cross: RscPictureKeepAspect
			{
				...
				h = "0.16 * safezoneH * 0";
				text = "ca\ui\data\cursor_uav_heli_gs.paa";
				colorText[] = {0.8275,0.8196,0.1961,1.0};
				idc = 1001;
				type = 0;
				colorbackground[] = {0,0,0,0};
				font = "EtelkaMonospaceProBold";
...
class RscDisplaySingleMission: RscStandardDisplay
{
	...
	class controlsBackground
	{
		...
		class MissionOverviewBack: RscText
		{
			...
			w = "(47/100)	* SafeZoneW";
			h = "(76/100)	* SafeZoneH";
			colorBackground[] = {"58/255","53/255","25/255","156/255"};
		};
		...
		class ListboxArrows: RscControlsGroup
		{
			...
			class Controls
			{
				...
				class Available_items: RscIGUIListNBox
				{
					...
					idcRight = 147;
					idcLeft = 146;
					colorPlayerItem[] = {0.8784,0.8471,0.651,1.0};
		...
		class G_GearItems: RscControlsGroup
		{
			...
			class Controls
			{
				class CA_Gear_slot_primary: RscActiveText
				{
					...
					color[] = {1,1,1,1};
					colorBackground[] = {0.8784,0.8471,0.651,1.0};
					colorBackgroundSelected[] = {0.8784,0.8471,0.651,1.0};
...
class RespawnMap
{
	...
	movingEnable = 1;
	objects[] = {};
	controls[] = {"RespawnTimerBar","RespawnMapArea","RespawnLocationLabel","MessageBar"};
	controlsBackground[] = {"MenuBackground"};
...
class RscDisplayWFCity: RscStandardDisplay
{
	...
	class controls
	{
		...
		{
			idc = 2;
			shortcuts[] = {"0x00050000 + 0","0x00050000 + 1",28,156,57};
			x = "0.283 + 0.0 + 0.02";
			y = 0.828439;
			text = "$STR_DISP_CLOSE";
...
class CfgInGameUI
{
	...
	class SideColors
	{
		colorFriendly[] = {0.4,0.6745,0.2784,1.0};
	...
	class Compass
	{
		...
		shadow = 2;
		color[] = {0.4,0.6745,0.2784,1.0};
		dirColor[] = {0.4,0.6745,0.2784,1.0};
	...
	class Radar
	{
		...
		radarFOVPlayer[] = {0.4,0.6745,0.2784,1.0};
	...
	class Hint
	{
		sound[] = {"\Ca\sounds\sfx\hint.wss",0.31622776,1};
	};
	class PlayerInfo
	{
		left = "0 + SafeZoneX";
	...
	class Menu
	{
		...
		colorEnabled[] = {0.4,0.6745,0.2784,1.0};
	...
	class Bar
	{
		...
		colorBackground[] = {0,0,0,0.0};
		colorGreen[] = {0.4,0.6745,0.2784,1.0};
		colorYellow[] = {0.4,0.6745,0.2784,1.0};
	...
	class Actions
	{
		...
		colorText[] = {0.4,0.6745,0.2784,1.0};
		colorSelect[] = {0.95,0.95,0.95,1};
		colorBackgroundSelected[] = {0.424,0.651,0.247,1};
	...
	class CommandBar
	{
		...
		colorGreenTeam[] = {0.4,0.6745,0.2784,1.0};
	...
	class Cursor
	{
		...
		dimmCmdStartTime = 5;
		dimmCmdEndTime = 10;
		selectColor[] = {0.4,0.6745,0.2784,1.0};
		...
		customMarkColor[] = {0.4,0.6745,0.2784,1.0};
	...
	class PeripheralVision
	{
		...
		cueFriendlyColor[] = {0.4,0.6745,0.2784,1.0};
	};
	class HitZones
	{
		shadow = 0;
...
class RscDisplayMultiplayer: RscStandardDisplay
{
	...
	class controlsbackground
	{
		...
		class CA_Progress2: RscProgress
		{
			...
			colorBar[] = {0.023529,0,0.0313725,1};
			colorFrame[] = {1,1,1,0};
		};
	...
	class controls
	{
		...
		class CA_ValueSessions: RscIGUIListBox
		{
			...
			SizeEx = 0.025;
			columns[] = {0.4,0.06,0.36,0.08,0.06,0.04};
		};
	};
};
...
class RscDisplayRemoteMissions: RscStandardDisplay
{
	...
	colorMission[] = {0.8784,0.8471,0.651,1.0};
...
class RscDisplayArcadeMap: RscMap
{
	...
	class controls: controls
	{
		...
		class TollBoxBack: CA_Title_Back
		{
			...
			w = 0.191;
			h = 0.185;
			colorText[] = {0.1961,0.1451,0.0941,1.0};
		};
...
class RscDisplayMissionEditor
{
	...
	class Controls
	{
		...
		class T_Background2: RscText
		{
			...
			w = 0.25;
			h = "SafeZoneH";
			colorBackground[] = {0.0941,0.1608,0.0627,0.75};
		};
		...
		class L_NewObject: RscListBox
		{
			...
			colorText[] = {0.95,0.95,0.95,1};
			color[] = {0.95,0.95,0.95,1};
			colorTextSelect[] = {0.0941,0.1608,0.0627,1};
			colorSelect[] = {0.0941,0.1608,0.0627,1};
			rows = 15;
			columns = 1;
		};
...
class RscDisplayScriptingHelp
{
	...
	class Controls
	{
		...
		class CA_Background: RscPicture
		{
			...
			h = 0.8;
			text = "#(argb,8,8,3)color(1,1,1,1)";
			colortext[] = {0.0941,0.1608,0.0627,1};
		};
